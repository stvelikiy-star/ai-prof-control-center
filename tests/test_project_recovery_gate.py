...
class ProjectRecoveryGateTests(unittest.TestCase):
    ...
    def test_production_ready_cannot_be_declared_without_all_evidence(self):
        root = self._root(self._contract(recovery_mode="verified", production_ready=True))
    ...
    def test_control_center_has_checkpoint_and_rollback_code_but_missing_fault_injection(self):
